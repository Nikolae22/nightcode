...
export function DialogSearchList<T>({
    items, onSelect, onHighlight, filterFn, renderItem,
    getKey, placeholder="Search", emptyText="No results"
    ...
    useKeyboard((key)=>{
        ...
        if(key.name === "retrun" || key.name === "enter"){
    ...
    return(
        ...
        >
            ...
            {filtered.length === 0 ? (
                ...
                <scrollbox
                ref={scrollRef} height={visibleHeight}>
                    ...
                    {filtered.map((item,i)=>{
                        ...
                        return(
                            ...
                            height={1}
                            overflow="hidden"
                            backgroundColor={isSelected ? colors.selection 
                                : undefined} //todo change with theme color
                            onMouseMove={()=>{
                                setSelectedIndex(i)
