...
//align all comand name in a fiexed-width colums so thei descriptions
//start at the sme horizontal position for a cler tabular look.
...
export function CommandMenu({
    ...
    if(filtered.length === 0){
        return(
            <box paddingX={1}>
                <text attributes={TextAttributes.DIM}>Not matching commands</text>
            </box>
        )
    }
